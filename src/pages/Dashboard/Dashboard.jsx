...
export default function Dashboard() {
  ...
  // Build stats array — real data where API provides it, placeholders where it doesn't yet
  const stats = [
    {
      title: "TOTAL EMPLOYEES",
      value: summary?.total_employees?.count ?? "-",
      change: "", // no change/delta field in API yet
      icon: <FiUsers />,
      bg: "#eaf2ff",
      color: "#2563eb",
    },
    {
      ...
      value: summary?.active_employees?.count ?? "-",
      change: "",
      icon: <FiCheckCircle />,
      bg: "#eaf8ed",
      color: "#22c55e",
    },
    {
      ...
      value: summary?.inactive_employees?.count ?? "-",
      change: "",
      icon: <FiX />,
      bg: "#fdecec",
      color: "#ef4444",
    },
    {
      ...
      value: summary?.uninformed_leaves?.count ?? "-",
      change: "",
      icon: <FiAlertCircle />,
      bg: "#fff6e6",
      color: "#f59e0b",
    },
    // TODO: Pending Approvals — no field in /dashboard/summary yet, confirm with backend
    {
      title: "PENDING APPROVALS",
      value: "14",
      change: "+4",
    ...
    // TODO: Monthly Payroll — no field in /dashboard/summary yet, confirm with backend
    {
      title: "MONTHLY PAYROLL",
      value: "₹31.2L",
      change: "+8.2%",
  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="dashboard-content">
        <Header title="Executive Dashboard" breadcrumb="Dashboard" />
        ...
        {/* BOTTOM SECTION — unchanged, still static for now */}
        <div className="bottom-row">
          <div className="widget">
            <h3>Quick Actions</h3>
            <div className="quick-grid">
              <div className="quick-card" onClick={() => navigate("/employees/add")}>
                <FiUsers />
                <span>Add Employee</span>
              </div>
              ...
              <div className="quick-card" onClick={() => navigate("/leave-management")}>
                <FiCalendar />
                <span>Approve Leave</span>
              </div>
              <div className="quick-card" onClick={() => navigate("/biometric-sync")}>
                <FiAlertCircle />
                <span>Sync Biometric</span>
              </div>
            </div>
