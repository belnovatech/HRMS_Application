...
export default function Recruitment() {
  ...
  const pipeline = {
    Applied: [
      { initials: "AG", name: "Aarti Gupta", role: "DevOps Engineer", exp: "5 yrs", color: "#52c41a" },
      { initials: "NM", name: "Nisha Malhotra", role: "HR Executive", exp: "2 yrs", color: "#7265f6" },
    ],
    Screening: [
      { initials: "SJ", name: "Saurabh Jain", role: "Data Scientist", exp: "3 yrs", color: "#6d3bd2" },
    ],
    Interview: [
      { initials: "RK", name: "Rishi Kapoor", role: "Frontend Dev", exp: "4 yrs", color: "#24bfc4" },
    ],
    Offer: [
      { initials: "MI", name: "Meera Iyer", role: "Product Manager", exp: "6 yrs", color: "#2f80ed" },
    ],
    Hired: [
      { initials: "PR", name: "Prakash Rao", role: "Backend Dev", exp: "7 yrs", color: "#f5a623" },
    ],
  };
  ...
  return (
    <HRLayout title="Recruitment & Hiring" breadcrumb="Recruitment">
      <div className="recruitment-container">
        <div className="pipeline-header">
          <h2 className="pipeline-title">Candidate Pipeline</h2>
              ...
              {candidates.map((candidate) => (
                <div key={candidate.name} className="candidate-card">
                  ...
                  <div className="candidate-bottom">
                    <span className="candidate-exp">{candidate.exp}</span>
        ...
        <div className="jobs-card">
          <div className="jobs-header">Active Job Posts</div>
          {jobs.map((job) => (
            <div className="job-row" key={job.id}>
              <div className="job-left">
                ...
                <div>
                  ...
                  <p className="job-subtitle">{job.department} • {job.posted}</p>
                </div>
              </div>
              ...
              <div className="job-right">
                ...
                <span className="active-tag">{job.status}</span>
          ...
          <div className="modal-overlay" onClick={() => setShowModal(false)}>
            <div className="job-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="modal-actions">
                ...
                <button className="submit-btn" onClick={() => setShowModal(false)}>Post Job</button>
              </div>
            </div>
          </div>
        )}
